...
if (isset($_POST['register'])) {
  ...
  if ($query->rowCount() == 0) {
    ...
    if ($result) {
      echo '<p class="alert alert-info text-center success top-0">Registrado com sucesso!</p>';
    } else {
...
<body>
  ...
  <form class="container w-25 p-3" method="post" action="" name="signup-form">
    ...
    <div class="row mb-4">
      ...
      <button class="btn btn-new text-light btn-block mb-4 mt-2" type="submit" name="register" value="register">Register</button>
